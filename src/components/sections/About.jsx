            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-8'>
                <div className='p-6 rounded-xl border border-white/10 hover:-translate-y-1 transition-all'>
                        ...
                        <ul className='list-disc list-inside text-gray-300 space-y-2'>
                            ...
                            <li>
                                Relevant Coursework: Data Structure and Algorithm, Computer Networks, 
                ...
                <div className='p-6 rounded-xl border border-white/10 hover:-translate-y-1 transition-all'>
                        ...
                        <div className='space-y-4 text-gray-300'>
                            <div  >
                                <h4 className='font-semibold'>Software Engineer Intern at CQ Company (2024/08-2025/02) </h4>
                                <p>
                                    Developed and maintained microservices for cloud-based applications.
                                </p>
                            </div>
                            <div>
                                <h4 className='font-semibold'>Freelance building Flutter Application</h4>
                                <li>
                                    Build Fitness Application
                                </li>
                                <li>Build Chess Application</li>
